...
function plotBode(data)
	plot(real(data), imag(data), framestyle = :origin, xlabel = "log(freq)", ylabel = "log(Z)", xlim = [0,100], ylim = [-50,0], label = "circuit1", yflip = false, seriestype = :scatter, title = "Bode Plot")
end
